...
public abstract class AbstractPassword extends Service {
    ...
    public final void valueReceived(java.util.Map<String, Object> properties, RemoteServiceInfo source, String eventName, Object value, Object... indexes) {
        if (eventName.equals("contact") && source.isCompatible("/Device/Device/PhysicalDevice/Sensor/ContactSensor/")) {
            ...
            PasswordValuePublishable returnValue = onContactFromContactSensor(contactFromContactSensor, new DiscoverForContactFromContactSensor());
     ...
     */
    protected abstract PasswordValuePublishable onContactFromContactSensor(ContactFromContactSensor contactFromContactSensor, DiscoverForContactFromContactSensor discover);
    ...
    protected final class DiscoverForContactFromContactSensor {
        private final TimerDiscovererForContactFromContactSensor timerDiscoverer = new TimerDiscovererForContactFromContactSensor(AbstractPassword.this);
