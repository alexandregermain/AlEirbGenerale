...
public abstract class AbstractUpdatePassword extends Service {
    
    public AbstractUpdatePassword(ServiceConfiguration serviceConfiguration) {
        super("/Context/UpdatePassword/", serviceConfiguration);
    }
    ...
    public final void valueReceived(java.util.Map<String, Object> properties, RemoteServiceInfo source, String eventName, Object value, Object... indexes) {
        if (eventName.equals("elapsedTime") && source.isCompatible("/Context/ElapsedTime/")) {
            ...
            UpdatePasswordValuePublishable returnValue = onElapsedTime(elapsedTimeValue);
            if(returnValue != null && returnValue.doPublish()) {
                setUpdatePassword(returnValue.getValue());
            }
        }
        if (eventName.equals("contact") && source.isCompatible("/Device/Device/PhysicalDevice/Sensor/ContactSensor/")) {
            ...
            UpdatePasswordValuePublishable returnValue = onContactFromContactSensor(contactFromContactSensor);
            if(returnValue != null && returnValue.doPublish()) {
                setUpdatePassword(returnValue.getValue());
            }
        }
        if (eventName.equals("on") && source.isCompatible("/Device/Device/PhysicalDevice/Appliance/Light/")) {
            ...
            UpdatePasswordValuePublishable returnValue = onOnFromLight(onFromLight);
            if(returnValue != null && returnValue.doPublish()) {
                setUpdatePassword(returnValue.getValue());
            }
        }
    ...
    public final Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String valueName,
        ...
        if (valueName.equals("updatePassword")) {
            return getLastValue();
        }
    ...
    private fr.inria.phoenix.diasuite.framework.datatype.passwordupdating.PasswordUpdating contextValue;
    
    private void setUpdatePassword(fr.inria.phoenix.diasuite.framework.datatype.passwordupdating.PasswordUpdating newContextValue) {
        contextValue = newContextValue;
        getProcessor().publishValue(getOutProperties(), "updatePassword", newContextValue);
    }
     ...
     */
    protected final fr.inria.phoenix.diasuite.framework.datatype.passwordupdating.PasswordUpdating getLastValue() {
        return contextValue;
    }
    
    /**
     * A class that represents a value that might be published for the <code>UpdatePassword</code> context. It is used by
     * event methods that might or might not publish values for this context.
     */
    protected final static class UpdatePasswordValuePublishable {
        ...
        public UpdatePasswordValuePublishable(fr.inria.phoenix.diasuite.framework.datatype.passwordupdating.PasswordUpdating value, boolean doPublish) {
            this.value = value;
         ...
         */
        public fr.inria.phoenix.diasuite.framework.datatype.passwordupdating.PasswordUpdating getValue() {
            return value;
        }
         ...
         */
        public void setValue(fr.inria.phoenix.diasuite.framework.datatype.passwordupdating.PasswordUpdating value) {
            this.value = value;
        }
     ...
     * @return a {@link UpdatePasswordValuePublishable} that says if the context should publish a value and which value it should publish
     */
    protected abstract UpdatePasswordValuePublishable onContactFromContactSensor(ContactFromContactSensor contactFromContactSensor);
    
    /**
     * This method is called when a <code>Light</code> device on which we have subscribed publish on its <code>on</code> source.
    <p>
    publish if setting sensor, else store id
     ...
     * @return a {@link UpdatePasswordValuePublishable} that says if the context should publish a value and which value it should publish
     */
    protected abstract UpdatePasswordValuePublishable onOnFromLight(OnFromLight onFromLight);
     ...
     * @return a {@link UpdatePasswordValuePublishable} that says if the context should publish a value and which value it should publish
     */
    protected abstract UpdatePasswordValuePublishable onElapsedTime(ElapsedTimeValue elapsedTimeValue);
