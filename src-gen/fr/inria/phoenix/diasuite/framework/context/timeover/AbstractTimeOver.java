...
public abstract class AbstractTimeOver extends Service {
    
    public AbstractTimeOver(ServiceConfiguration serviceConfiguration) {
        super("/Context/TimeOver/", serviceConfiguration);
    }
    ...
    public final void valueReceived(java.util.Map<String, Object> properties, RemoteServiceInfo source, String eventName, Object value, Object... indexes) {
        if (eventName.equals("timerTriggered") && source.isCompatible("/Device/Device/Service/Timer/")) {
            ...
            TimeOverValuePublishable returnValue = onTimerTriggeredFromTimer(timerTriggeredFromTimer, new DiscoverForTimerTriggeredFromTimer());
            if(returnValue != null && returnValue.doPublish()) {
                setTimeOver(returnValue.getValue());
            }
        }
    }
    ...
    private void setTimeOver(java.lang.Boolean newContextValue) {
        contextValue = newContextValue;
        getProcessor().publishValue(getOutProperties(), "timeOver", newContextValue);
    }
    ...
    /**
     * A class that represents a value that might be published for the <code>TimeOver</code> context. It is used by
     * event methods that might or might not publish values for this context.
     */
    protected final static class TimeOverValuePublishable {
        ...
        public TimeOverValuePublishable(java.lang.Boolean value, boolean doPublish) {
            this.value = value;
     ...
     * @return a {@link TimeOverValuePublishable} that says if the context should publish a value and which value it should publish
     */
    protected abstract TimeOverValuePublishable onTimerTriggeredFromTimer(TimerTriggeredFromTimer timerTriggeredFromTimer, DiscoverForTimerTriggeredFromTimer discover);
    ...
    protected final class DiscoverForTimerTriggeredFromTimer {
        private final TimerDiscovererForTimerTriggeredFromTimer timerDiscoverer = new TimerDiscovererForTimerTriggeredFromTimer(AbstractTimeOver.this);
