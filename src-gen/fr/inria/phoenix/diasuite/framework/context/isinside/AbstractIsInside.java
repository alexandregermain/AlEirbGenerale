package fr.inria.phoenix.diasuite.framework.context.isinside;
...
public abstract class AbstractIsInside extends Service {
    
    public AbstractIsInside(ServiceConfiguration serviceConfiguration) {
        super("/Context/IsInside/", serviceConfiguration);
    }
    ...
    public final void valueReceived(java.util.Map<String, Object> properties, RemoteServiceInfo source, String eventName, Object value, Object... indexes) {
        if (eventName.equals("inactivityLevel") && source.isCompatible("/Device/Device/Service/SoftwareSensor/InactivitySensor/")) {
            ...
            IsInsideValuePublishable returnValue = onInactivityLevelFromInactivitySensor(inactivityLevelFromInactivitySensor, new DiscoverForInactivityLevelFromInactivitySensor());
            if(returnValue != null && returnValue.doPublish()) {
                setIsInside(returnValue.getValue());
            }
        }
    }
    ...
    private void setIsInside(java.lang.Boolean newContextValue) {
        contextValue = newContextValue;
        getProcessor().publishValue(getOutProperties(), "isInside", newContextValue);
    }
    ...
    /**
     * A class that represents a value that might be published for the <code>IsInside</code> context. It is used by
     * event methods that might or might not publish values for this context.
     */
    protected final static class IsInsideValuePublishable {
        ...
        public IsInsideValuePublishable(java.lang.Boolean value, boolean doPublish) {
            this.value = value;
     ...
     * @return a {@link IsInsideValuePublishable} that says if the context should publish a value and which value it should publish
     */
    protected abstract IsInsideValuePublishable onInactivityLevelFromInactivitySensor(InactivityLevelFromInactivitySensor inactivityLevelFromInactivitySensor, DiscoverForInactivityLevelFromInactivitySensor discover);
    ...
    protected final class DiscoverForInactivityLevelFromInactivitySensor {
        private final InactivitySensorDiscovererForInactivityLevelFromInactivitySensor inactivitySensorDiscoverer = new InactivitySensorDiscovererForInactivityLevelFromInactivitySensor(AbstractIsInside.this);
