...
import fr.inria.phoenix.diasuite.framework.device.smssender.AbstractSMSSender;

// @internal
public final class SMSSenderMock {
    ...
    class Proxy extends AbstractSMSSender {
    ...
    SMSSenderMock(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue) {
