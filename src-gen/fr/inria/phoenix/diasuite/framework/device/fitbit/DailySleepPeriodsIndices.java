...
/**
 * Container for the indices of the source <code>dailySleepPeriods</code> from device <code>Fitbit</code>.
<p>
sleep
 ...
 */
public final class DailySleepPeriodsIndices implements Serializable {
    private static final long serialVersionUID = 0;
    
    public DailySleepPeriodsIndices(fr.inria.phoenix.diasuite.framework.datatype.date.Date day) {
        this._day = day;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DailySleepPeriodsIndices other = (DailySleepPeriodsIndices) obj;
        if (_day == null) {
            if (other._day != null)
                return false;
