...
/**
 * Container for the indices of the source <code>dailyPulses</code> from device <code>Fitbit</code>.
<p>
pulses
 ...
 */
public final class DailyPulsesIndices implements Serializable {
    private static final long serialVersionUID = 0;
    
    public DailyPulsesIndices(fr.inria.phoenix.diasuite.framework.datatype.date.Date day) {
        this._day = day;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DailyPulsesIndices other = (DailyPulsesIndices) obj;
        if (_day == null) {
            if (other._day != null)
                return false;
