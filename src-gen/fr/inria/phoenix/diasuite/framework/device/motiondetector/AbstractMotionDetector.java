package fr.inria.phoenix.diasuite.framework.device.motiondetector;
...
public abstract class AbstractMotionDetector extends Service {
    ...
    public AbstractMotionDetector(ServiceConfiguration serviceConfiguration,
    ...
    /**
     * Returns the value of source <code>motion</code> from device <code>MotionDetector</code>.
    
    <pre>
    source motion as Boolean;
    </pre>
    @return the value of the source <code>motion</code>
     */
