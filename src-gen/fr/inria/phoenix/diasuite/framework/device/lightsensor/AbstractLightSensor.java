...
public abstract class AbstractLightSensor extends Service {
    ...
    public AbstractLightSensor(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("/Device/Device/PhysicalDevice/Sensor/LightSensor/", serviceConfiguration);
        updateId(idValue);
    ...
    public Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        ...
        if (orderName.equals("lightLevel")) {
    ...
    private java.lang.Float _lightLevel;
    ...
    protected void publishLightLevel(java.lang.Float newLightLevelValue) {
        ...
        getProcessor().publishValue(getOutProperties(), "lightLevel", newLightLevelValue); 
    }
