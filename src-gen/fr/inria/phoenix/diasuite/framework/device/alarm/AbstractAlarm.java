 ...
 */
public abstract class AbstractAlarm extends Service {
    
    public AbstractAlarm(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue) {
        super("/Device/Device/Service/Alarm/", serviceConfiguration);
        updateId(idValue);
    }
    ...
    /**
     * Implement this method to define the <code>on</code> order from the <code>DesactiverAlarm</code> action
     * defined in device Alarm.
     * 
