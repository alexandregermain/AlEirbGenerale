...
public abstract class AbstractContactSensor extends Service {
    ...
    public AbstractContactSensor(ServiceConfiguration serviceConfiguration,
    ...
    private java.lang.Boolean _contact;
     ...
     */
    protected void publishContact(java.lang.Boolean newContactValue) {
        _contact = newContactValue;
        getProcessor().publishValue(getOutProperties(), "contact", newContactValue); 
    }
    
    /**
     * Returns the value of source <code>contact</code> from device <code>ContactSensor</code>.
