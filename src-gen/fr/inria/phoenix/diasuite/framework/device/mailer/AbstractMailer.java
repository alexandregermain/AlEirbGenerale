 ...
 */
public abstract class AbstractMailer extends Service {
    
    public AbstractMailer(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue) {
        super("/Device/Device/Service/CommunicationService/Messenger/Mailer/", serviceConfiguration);
        updateId(idValue);
    }
    ...
    public Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        ...
        if (orderName.equals("unreadEmailCount")) {
    ...
    private java.lang.Integer _unreadEmailCount;
     ...
     */
    protected void publishUnreadEmailCount(java.lang.Integer newUnreadEmailCountValue) {
        _unreadEmailCount = newUnreadEmailCountValue;
        getProcessor().publishValue(getOutProperties(), "unreadEmailCount", newUnreadEmailCountValue); 
    }
    
    /**
     * Returns the value of source <code>unreadEmailCount</code> from device <code>Mailer</code>.
     ...
     */
    protected java.lang.Integer getUnreadEmailCount() throws Exception {
        return _unreadEmailCount;
    }
    // End of code for source unreadEmailCount from device Mailer
