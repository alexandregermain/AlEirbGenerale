 ...
 */
public abstract class AbstractCooker extends Service {
    
    public AbstractCooker(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("(/Device/Device/PhysicalDevice/Appliance/|/Device/Device/PhysicalDevice/Sensor/EnergyMeter/ElectricMeter/)Cooker/", serviceConfiguration);
        updateId(idValue);
    ...
    public Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        ...
        if (orderName.equals("consumption")) {
    ...
    private java.lang.Float _consumption;
     ...
     */
    protected void publishConsumption(java.lang.Float newConsumptionValue) {
        _consumption = newConsumptionValue;
        getProcessor().publishValue(getOutProperties(), "consumption", newConsumptionValue); 
    }
    
    /**
     * Returns the value of source <code>consumption</code> from device <code>ElectricMeter</code>.
